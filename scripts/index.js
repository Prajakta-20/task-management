...
const htmlTaskContent = ({ id, title, description, type, url }) => `
    <div class='col-md-6 col-lg-4 mt-3' id=${id} key=${id}>
        <div class='card shadow-sm task__card'>
            ...
            <div class='card-body'>
                ${url
        ? `<img width='100%' height="150px" style="object-fit: cover; object-position: center" src=${url} alt='card image caption' class='card-image-top md-3 rounded-lg' />`
        : `<img width='100%' height="150px" style="object-fit: cover; object-position: center" src="https://newhorizon-information-science-engineering.s3.ap-south-1.amazonaws.com/nhengineering/information-science-engineering/wp-content/uploads/2020/01/17094526/default-image.png" alt='card image caption' class='card-image-top md-3 rounded-lg' />`
    }
